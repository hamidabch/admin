   ...
   <header class="header">
      ...
      <section class="flex">
         ...
         <div class="profile">
            ...
            <div class="flex-btn">
               <a href="profile.html" class="option-btn"> Profile</a>
...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <div class="box">  
         ...
         <a href="internal.php" class="btn"> <img src="../../desgin/images/High School-amico.png" alt="" style="width: 310px;">
            <h3 class="title" style="font-size: 2.7rem;">Internal</h3>
            </a>
      </div>

          <div class="box">
            <a href="externli.php" class="btn"> <img src="../../desgin/images/Company-rafiki.png" alt="" style="width: 310px;">
