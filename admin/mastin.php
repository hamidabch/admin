...
<body>
   ...
   <header class="header">
      ...
      <section class="flex">
         <div class="links">
            <a href="mastin.php" class="upnavbar" ><i class="fa-solid fa-book-open-reader"></i>pfe subjects</a>
            <a href="assigm.php" class="upnavbar"><i class="fa-solid fa-list-check"></i>Topic Selection and Assignment Overview</a>
         </div>
...
<section class="courses">
   ...
   <h1 class="heading">internal master's subjects</h1>
